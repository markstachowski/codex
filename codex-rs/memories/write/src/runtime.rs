...
mod managed_service_tier_tests {
    ...
    #[test]
    fn locked_model_policy_managed_memory_preserves_choices_on_standard() {
        for lane in [
            ...
            assert_eq!(managed.model, "root-model");
            assert_eq!(managed.reasoning_effort, Some(ReasoningEffort::High));
            assert_eq!(
